...
from pytorch_forecasting import RecurrentNetwork, DeepAR
from pytorch_forecasting.data import TimeSeriesDataSet
from pytorch_forecasting.metrics import QuantileLoss, MAPE, SMAPE, NormalDistributionLoss
...
def optimize_hyperparameters_for_DeepAR(
    train_dataloaders: DataLoader,
    val_dataloaders: DataLoader,
    model_path: str,
    max_epochs: int = 20,
